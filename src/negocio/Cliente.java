...
public class Cliente {
	...
	/**
	 * M�todo que compara dois clientes para ver se sao os mesmos
	 * @return true se forem os mesmos, e false caso contrario
	 */
	@Override
	public boolean equals(Object obj) {
	    ...
	    return id == cliente1.id &&
	    		nome.equals(cliente1.nome) &&
	           idade == cliente1.idade &&
	           email.equals(cliente1.email) &&
	           idContaCorrente == cliente1.idContaCorrente &&
	           ativo == cliente1.ativo;
	}
